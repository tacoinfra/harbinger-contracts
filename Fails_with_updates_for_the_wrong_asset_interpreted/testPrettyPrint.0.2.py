...
class Contract(sp.Contract):
  def __init__(self):
    self.init(assetCode = 'BTC-USD', computedPrice = 0, lastUpdateTime = sp.timestamp(0), numDataPoints = 3, oracleContract = sp.address('KT1QLPABNCD4z1cSYVv3ntYDYgtWTed7LkYr'), prices = sp.record(first = 0, last = -1, saved = {0 : 0}, sum = 0), volumes = sp.record(first = 0, last = -1, saved = {0 : 0}, sum = 0))
